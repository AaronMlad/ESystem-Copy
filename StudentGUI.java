...
public class StudentGUI extends javax.swing.JFrame {
    ...
    private void SaveActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        if (rs.next()) {
            ...
            firstLetter = firstLetter.replaceAll("[^a-z]", "s"); // default to 's' if not a letter
            
            // Create username as ID + full name without spaces (lowercase)
            String username = studentId + name.replaceAll("\\s+", "").toLowerCase();
            ...
            if (userCheck.next()) {
                ...
                JOptionPane.showMessageDialog(this, 
                    "Student saved successfully!\n" +
                    "New database user created with SELECT privileges:\n" +
                    "Username: " + username + "\n" +
                    "Password: " + password);
            }
        }
    ...
    private void DeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_DeleteActionPerformed
        try {
            ...
            if (studentName.isEmpty()) {
                JOptionPane.showMessageDialog(this, "Cannot delete: Student name is empty",
                    "Error", JOptionPane.ERROR_MESSAGE);
                return;
            }

            // Create username as ID + full name without spaces (lowercase)
            String username = studentId + studentName.replaceAll("\\s+", "").toLowerCase();
            ...
            // Delete the student record from the current database
    ...
    private void firstSemActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        updateSemLabel(); // Update label when database changes
    }
